...
func main() {
	...
	userName := "test_AdminDeleteUser"
	password := "test_AdminDeleteUser"
	...
	// Delete
	paramsDelete := &cognitoidentityprovider.AdminDeleteUserInput{
		UserPoolId: aws.String(userPoolId),
		Username:   aws.String(userName),
	}

	respDelete, errDelete := svc.AdminDeleteUser(paramsDelete)
	if errDelete != nil {
